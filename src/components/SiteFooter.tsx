...
export function SiteFooter() {
  return (
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-24 -left-24 w-48 h-48 bg-gradient-to-tr from-cyan-200/30 to-teal-200/30 rounded-full blur-3xl" />
        <div className="absolute -bottom-24 -right-24 w-48 h-48 bg-gradient-to-tr from-purple-200/30 to-indigo-200/30 rounded-full blur-3xl" />
      </div>

      <div className="relative mx-auto max-w-7xl px-4 py-16 text-gray-900/80">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
                      <motion.div 
                        ...
                        transition={{ duration: 0.6 }}
                        className="h-10 w-10 rounded-xl bg-gradient-to-tr from-cyan-500 via-teal-500 to-emerald-500 flex items-center justify-center shadow-lg"
                      >
            ...
            <div className="flex items-center gap-4">
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
                href="#" 
                        className="w-10 h-10 rounded-full bg-cyan-100 flex items-center justify-center text-cyan-600 hover:bg-cyan-200 transition-colors"
              >
            ...
            <ul className="space-y-3">
              {[
                ...
                >
                  <Link 
                    href={item.href} 
                    className="text-gray-900/80 hover:text-orange-600 transition-colors flex items-start gap-2 group"
                  >
                    <span className="w-1.5 h-1.5 bg-orange-400 rounded-full mt-2 group-hover:bg-orange-500"></span>
                    <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                >
                  <Link 
                    href={item.href} 
                    className="text-gray-900/80 hover:text-orange-600 transition-colors flex items-center gap-2"
                  >
        ...
        <motion.div 
          ...
          className="mt-16 pt-8 border-t border-orange-200/60"
        >
